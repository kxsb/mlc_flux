...
def api_monetary_indicators():
    """
    Indicateurs de masse monétaire / garantie.

    Les données sont lues depuis le modèle monétaire interne MLCFlux,
    indépendamment du provider qui les a alimentées.
    """
